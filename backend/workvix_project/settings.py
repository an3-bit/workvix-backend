"""
Django settings for workvix_project project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-64&bu!m985@!g%@(6&(_rz^5s%nl*d@ovx8958(jfjxw4t714e')
...
ROOT_URLCONF = 'workvix_project.urls'
...
WSGI_APPLICATION = 'workvix_project.wsgi.application'
...
# Allow cross-site requests from the frontend dev server
